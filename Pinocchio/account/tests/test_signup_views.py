...
class FacultySignUpTest(TestCase):
    ...
    def test_post_faculty_invalid(self):
        ...
        self.assertTemplateUsed(response, 'account/faculty_signup.html')
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'faculty_signup_form', 'username', 'A user with that username already exists.')
        self.assertFormError(response, 'faculty_signup_form', 'email', 'Email already exists')
...
class StaffSignUpTest(TestCase):
    ...
    def test_post_staff_invalid(self):
        ...
        self.assertTemplateUsed(response, 'account/staff_signup.html')
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'staff_signup_form', 'username', 'A user with that username already exists.')
        self.assertFormError(response, 'staff_signup_form', 'email', 'Email already exists')
...
class StudentSignUpTest(TestCase):
    ...
    def test_post_student_invalid(self):
        ...
        self.assertTemplateUsed(response, 'account/student_signup.html')
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'student_signup_form', 'username', 'A user with that username already exists.')
        self.assertFormError(response, 'student_signup_form', 'email', 'Email already exists')
